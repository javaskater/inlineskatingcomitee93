...
/**
 * My Copy of Class Name: wp_bootstrap_navwalker
...
class linlineskating93_navwalker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
			...
			$item_output .= '<span class="tdroit">'.$args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after;
			//$item_output .= ( $args->has_children ) ? ' <span class="caret"></span></div></a>' : '</div></a>';
			$item_output .= '</span></a>';
